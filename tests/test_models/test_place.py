''' Ce module définit des tests pour la place '''
...
class TestPlace(unittest.TestCase):
    '''
    Cette classe effectue des tests sur la place
    '''
    ...
    def setUp(self):
        ...
        self.place.amenity_ids = ["AmenityID1", "AmenityID2"]
    ...
    def test_place_instance(self):
        ''' Ce test vérifie l'instance de la place '''
        self.assertIsInstance(self.place, Place)

    def test_place_attributes(self):
        ''' Ce test vérifie les attributs de la place '''
        ...
        self.assertEqual(self.place.amenity_ids, ["AmenityID1", "AmenityID2"])
